...
<form:form method="post" action="${formSubmitAction}" class="form-horizontal" >
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <form:input path="serverURL" name="serverURL" placeholder="http://localhost:8080/ag-push" class="form-control input-md" required="requis"/>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <form:input path="applicationID" name="applicationID" placeholder="c7fc6525-5506-4ca9-9cf1-55cc261ddb9c" class="form-control input-md" required="requis"/>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <form:input path="masterSecret" name="masterSecret" placeholder="8b2f43a9-23c8-44fe-bee9-d6b0af9e316b" class="form-control input-md" required="requis"/>
            </div>
